<template>
  <AppHead :title="$t('Privacy Policy')" />

  <ConstrainedContainer class="mt-32">
    <article class="prose mx-auto dark:prose-invert">
      <h1>Privacy Policy</h1>

      <p>
        Your privacy is important to us. It is Moon Pixels Ltd&#39;s policy to respect your privacy and comply with any
