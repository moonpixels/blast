    ...
    >
      ...
      <div class="text-xs">
        ...
        <span class="mt-2 block">
          {{ $t('Moon Pixels Ltd is a company registered in England and Wales with company number 14080344.') }}
        </span>

        <span class="mt-2 block flex items-center gap-2">
          <InternalLink :href="route('terms')">
            {{ $t('Terms of Service') }}
          </InternalLink>

          <span>|</span>

          <InternalLink :href="route('privacy')">
            {{ $t('Privacy Policy') }}
          </InternalLink>
        </span>
      </div>
